...
void make_hist_CTime_fall18(TString basename="",Int_t nrun=1267,Double_t cpeak=45){
   if (basename=="") {
...
// Define branches
 ...
 Double_t  hT1_tdcTime;
   tsimc->SetBranchAddress("T.coin.hT1_tdcTime",&hT1_tdcTime);
 ...
 Double_t  hTRIG1_ROC1_tdcTime;
  ...
  Double_t  hPRE100_ROC1_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.hPRE100_ROC1_tdcTimeRaw",&hPRE100_ROC1_tdcTimeRaw);
Double_t  pTRIG4_ROC2_tdcTimeRaw;
 ...
 Double_t  hstarttime;
   ...
   TH1F *hpdiff_pre40_reftime = new TH1F("hpdiff_pre40_reftime",Form("Run %d ;SHMS Pre40-reftime;Counts",nrun), 100, xlo,xhi);
    HList.Add(hpdiff_pre40_reftime);
    TH1F  *h_diff_ht1_hstart = new TH1F("h_diff_ht1_hstart",Form("Run %d ;HMST1 - hstart;Counts",nrun), 100, 0,500);
    HList.Add(h_diff_ht1_hstart);
    TH1F *hpdiff_trig1_reftime = new TH1F("hpdiff_trig1_reftime",Form("Run %d ;ROC2 T2 - Trig1;Counts",nrun), 100, -10,10);
    HList.Add(hpdiff_trig1_reftime);
    TH1F *hpdiff_trig4_hpre40 = new TH1F("hpdiff_trig4_hpre40",Form("Run %d ;ROC2 hpre40-Trig4;Counts",nrun), 100, -20,40);
    HList.Add(hpdiff_trig4_hpre40);
   TH2F *h_diff_pre40_cointime = new TH2F("h_diff_pre40_cointime",Form("Run %d ;SHMS Pre 40 - HMS pre40 ; epi Cointime",nrun), 80, xlo,xhi,80,35,55);
    HList.Add(h_diff_pre40_cointime);
   TH2F *h_trig1diff_cointime = new TH2F("h_trig1diff_cointime",Form("Run %d ;ROC2 T2 - Trig1 ; epi Cointime",nrun), 80, xlo,xhi,80,35,55);
    HList.Add(h_trig1diff_cointime);
   TH2F *h_trig4diff_cointime = new TH2F("h_trig4diff_cointime",Form("Run %d ;ROC2 hpre40 - Trig4;    epi Cointime",nrun), 80, xlo,xhi,80,35,55);
    HList.Add(h_trig4diff_cointime);
   TH2F *h_t2hpre40diff_cointime = new TH2F("h_t2hpre40diff_cointime",Form("Run %d ;ROC2 t2 - hpre40;    epi Cointime",nrun), 80, -50,50,80,35,55);
    HList.Add(h_t2hpre40diff_cointime);
    TH2F *h_shms_pre40_cointime = new TH2F("h_shms_pre40_cointime",Form("Run %d ;SHMS Pre 40 ; COinttime  ",nrun), 160, xlo,xhi,160,35,55);
    HList.Add(h_shms_pre40_cointime);
    TH2F *h_hms_pre40_cointime = new TH2F("h_hms_pre40_cointime",Form("Run %d ;HMS Pre 40 ; COinttime  ",nrun), 160, xlo,xhi,160,35,55);
    HList.Add(h_hms_pre40_cointime);
   xlo=-30.;
   xhi=30.;
   if (nrun >=6630) {
    xlo=-20.;
   ...
   TH1F *h_diff_trig4_hstof = new TH1F("h_diff_trig4_hstof",Form("Run %d ;pTrig4-hSTOF;Counts",nrun), 80, xlo,xhi);
    HList.Add(h_diff_trig4_hstof);
   TH1F *h_diff_trig4_hstof_roc1 = new TH1F("h_diff_trig4_hstof_roc1",Form("Run %d ;ptrig4-hSTOF ROC1;Counts",nrun), 320, xlo,xhi);
    HList.Add(h_diff_trig4_hstof_roc1);
    TH2F *h_hstofdiff_cointime = new TH2F("h_hstofdiff_cointime",Form("Run %d ;HMS stof diff ; COinttime+SHMS trig1 diff  ",nrun), 160, -30,30,160,35,55);
    HList.Add(h_hstofdiff_cointime);
    TH2F *h_hstofdiff_cointime2 = new TH2F("h_hstofdiff_cointime2",Form("Run %d ;HMS stof diff ; COinttime+SHMS trig4 diff  ",nrun), 160, -30,30,160,35,55);
    HList.Add(h_hstofdiff_cointime2);
   xlo=-100.;
   xhi=100.;
   if (nrun >=6630) {
    xlo=-20.;
   ...
   TH1F *hhdiff_pre40_reftime = new TH1F("hhdiff_pre40_reftime",Form("Run %d ;HMS Pre40-Reftime;Counts",nrun), 400, xlo,xhi);
    HList.Add(hhdiff_pre40_reftime);
   TH1F *hhdiff_pre100_reftime = new TH1F("hpdiff_pre100_reftime",Form("Run %d ;HMS Pre100-Reftime;Counts",nrun), 400, xlo,xhi);
    HList.Add(hhdiff_pre100_reftime);
    TH2F *h_diff_pre40_starttime = new TH2F("h_diff_pre40_starttime",Form("Run %d ;SHMS Pre 40 - HMS pre40 ; SHMS starttime - HMS starttime",nrun), 80, -55,-35,40,20,30);
    HList.Add(h_diff_pre40_starttime);
    TH2F *h_diff_pre40_cointime_trig1 = new TH2F("h_diff_pre40_cointime_trig1",Form("Run %d ;SHMS Pre 40 ; COinttime Trig1  ",nrun), 160, -10,10,160,75,85);
    HList.Add(h_diff_pre40_cointime_trig1);
    TH2F *h_hms_pre40_cointimecorr = new TH2F("h_hms_pre40_cointimecoor",Form("Run %d ;HMS Pre 40 ; COinttime+SHMS pre40 diff  ",nrun), 160, -10,10,160,35,55);
    HList.Add(h_hms_pre40_cointimecorr);
    TH1F *hepiCoinTime_ROC2_corr = new TH1F("hepicoinTime_ROC2_corr",Form("Run %d ; epiCoinTime_ROC2 Corrected  ;Counts",nrun),800, 0.,100.0);
    HList.Add(hepiCoinTime_ROC2_corr);
    TH1F *hepiCoinTime_ROC2_corr_reg2 = new TH1F("hepicoinTime_ROC2_corr_reg2",Form("Run %d ; epiCoinTime_ROC2 Corrected  ;Counts",nrun),800, 0.,100.0);
    HList.Add(hepiCoinTime_ROC2_corr_reg2);
    TH1F *hepiCoinTime_ROC2_corr_reg3 = new TH1F("hepicoinTime_ROC2_corr_reg3",Form("Run %d ; epiCoinTime_ROC2 Corrected  ;Counts",nrun),800, 0.,100.0);
    HList.Add(hepiCoinTime_ROC2_corr_reg3);
    TH1F *hepiCoinTime_ROC2_corr_reg4 = new TH1F("hepicoinTime_ROC2_corr_reg4",Form("Run %d ; epiCoinTime_ROC2 Corrected  ;Counts",nrun),800, 0.,100.0);
    HList.Add(hepiCoinTime_ROC2_corr_reg4);
    TH1F *hepiCoinTime_ROC2_corr2 = new TH1F("hepicoinTime_ROC2_corr2",Form("Run %d ; epiCoinTime_ROC2- SHMS diff  ;Counts",nrun),800, 0.,100.0);
    HList.Add(hepiCoinTime_ROC2_corr);
    //
...
// loop over entries
	...
	for (int ie = 0; ie < nentries; ie++) {
		...
		Bool_t selcut=pntr>0 && hntr >0&&hcer>1.5;
		...
		Double_t coin_ROC2_calc =  (pTRIG4_ROC2_tdcTime + pstarttime) - (pTRIG4_ROC2_tdcTime + hstarttime);
                Double_t stof_roc2_offset = -149.5;
                Double_t stof_roc1_offset = -18;
		Double_t pPre40_roc2_offset = 120;
		if (nrun >= 6630) {
                    stof_roc2_offset = -150;
                    stof_roc1_offset = -150;
		    pPre40_roc2_offset = 140;
		}
		Double_t hstofdiff = .09776*(pTRIG4_ROC2_tdcTimeRaw-hSTOF_ROC2_tdcTimeRaw)+stof_roc2_offset;
		Double_t hstofdiff_roc1 = .09776*(hT1_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+stof_roc1_offset;
		Double_t pre40diff= 0.09776*((pT2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)-(hT1_tdcTimeRaw-hPRE40_ROC1_tdcTimeRaw));
		Double_t Sdiff = pstarttime-hstarttime;
		  Double_t  shms_pre40_diff=.09776*(pT2_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+pPre40_roc2_offset;
		  Double_t  shms_trig1_diff=.09776*(pT2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)+91;
		  Double_t  hms_trig4_diff=.09776*(hPRE40_ROC2_tdcTimeRaw-pTRIG4_ROC2_tdcTimeRaw);
		  Double_t  hms_pre40_diff=.09776*(hT1_tdcTimeRaw-hPRE40_ROC1_tdcTimeRaw)+71;
		  Double_t  hms_pre100_diff=.09776*(hT1_tdcTimeRaw-hPRE100_ROC1_tdcTimeRaw)+71;
		  Double_t  shms_trig4_diff=-.09776*(hPRE40_ROC2_tdcTimeRaw-pTRIG4_ROC2_tdcTimeRaw)-60;	
		  Double_t roc2_t2_hpre40_diff=shms_trig1_diff+hms_trig4_diff;
		  Double_t diff_ht1_hstart=pTRIG4_ROC1_tdcTime-hstarttime;
		  h_diff_ht1_hstart->Fill(diff_ht1_hstart);
		hpdiff_pre40_reftime->Fill(shms_pre40_diff);
		hhdiff_pre40_reftime->Fill(hms_pre40_diff);
		hpdiff_trig1_reftime->Fill(shms_trig1_diff);
		hhdiff_pre100_reftime->Fill(hms_pre100_diff);
		hpdiff_trig4_hpre40->Fill(shms_trig4_diff);
		h_diff_trig4_hstof->Fill(hstofdiff);		
		h_diff_trig4_hstof_roc1->Fill(hstofdiff_roc1);		
		h_diff_pre40_starttime->Fill(pre40diff,Sdiff);
		...
		if (paero>=2) {
                  h_diff_pre40_cointime->Fill(pre40diff+50,ePiCoinTime_ROC2);
                  h_hms_pre40_cointimecorr->Fill(hms_pre100_diff,ePiCoinTime_ROC2+shms_pre40_diff);
                  h_shms_pre40_cointime->Fill(shms_pre40_diff,ePiCoinTime_ROC2); 
		  h_trig1diff_cointime->Fill(shms_trig1_diff,ePiCoinTime_ROC2);
		  h_trig4diff_cointime->Fill(shms_trig4_diff,ePiCoinTime_ROC2);
		  h_t2hpre40diff_cointime->Fill(roc2_t2_hpre40_diff,ePiCoinTime_ROC2);
		  //                  h_hstofdiff_cointime->Fill(hstofdiff,ePiCoinTime_ROC2+shms_pre40_diff);
    	                     h_hstofdiff_cointime->Fill(hstofdiff,ePiCoinTime_ROC2+shms_trig1_diff);
		h_hstofdiff_cointime2->Fill(hstofdiff,ePiCoinTime_ROC2+shms_trig4_diff);
  		hpbetatrackpi->Fill(pbetatrack);
                   hepiCoinTime_ROC1->Fill(ePiCoinTime_ROC1);
 		 hepiCoinTime_ROC2->Fill(ePiCoinTime_ROC2);
                 hepiCoinTime_ROC2_corr2->Fill(ePiCoinTime_ROC2+shms_pre40_diff+hstofdiff);
 	if (abs(hstofdiff)<=2)hepiCoinTime_ROC2_corr->Fill(ePiCoinTime_ROC2+shms_trig1_diff+hstofdiff);
 	if (abs(hstofdiff+3.5)<1.5)hepiCoinTime_ROC2_corr_reg2->Fill(ePiCoinTime_ROC2+shms_trig1_diff+hstofdiff+3.5);
 	if (abs(hstofdiff+12.5)<3)hepiCoinTime_ROC2_corr_reg3->Fill(ePiCoinTime_ROC2+shms_trig1_diff+hstofdiff+12.5);
 	if (abs(hstofdiff-7)<2)hepiCoinTime_ROC2_corr_reg4->Fill(ePiCoinTime_ROC2+shms_trig1_diff+hstofdiff-7);
                   hepiCoinTime_TRIG1->Fill(ePiCoinTime_TRIG1);
                   h_diff_pre40_cointime_trig1->Fill(shms_pre40_diff,ePiCoinTime_TRIG1);
