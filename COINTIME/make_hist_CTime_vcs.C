...
void make_hist_CTime_vcs(TString basename="",Int_t nrun=1267,Double_t cpeak=45){
   if (basename=="") {
...
// Define branches
 ...
 Double_t  hstarttime;
   ...
   // Define histograms
    ...
    //
    TH1F *hCoinTime_RAW_ROC1 = new TH1F("hcoinTime_RAW_ROC1",Form("Run %d ; CoinTime_RAW_ROC1  ;Counts",nrun),100, -100.,100.0);
    HList.Add(hCoinTime_RAW_ROC1);
    TH1F *hCoinTime_RAW_ROC1_calc = new TH1F("hcoinTime_RAW_ROC1_calc",Form("Run %d ; CoinTime_RAW_ROC1_cla  ;Counts",nrun),800, 0.,+200.0);
    HList.Add(hCoinTime_RAW_ROC1_calc);
    TH1F *hCoinTime_RAW_ROC2 = new TH1F("hcoinTime_RAW_ROC2",Form("Run %d ; CoinTime_RAW_ROC2  ;Counts",nrun),100, -100.,100);
   TH1F *hCoinTime_RAW_ROC2_calc = new TH1F("hcoinTime_RAW_ROC2_calc",Form("Run %d ; CoinTime_RAW_ROC2_calc  ;Counts",nrun),800, 0.,200.0);
