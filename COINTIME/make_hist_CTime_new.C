...
Double_t shmstdc_tofcorr[plnum][iside][21];
 ...
 for (Int_t is=0;is<iside;is++) {
   ...
   tsimc->SetBranchAddress(Form("P.hod.%s.Good%sTdcTimeUnCorr",plname[ipl],sidename[is]),&shmstdc_uncorr[ipl][is]) ;
   tsimc->SetBranchAddress(Form("P.hod.%s.Good%sTdcTimeTOFCorr",plname[ipl],sidename[is]),&shmstdc_tofcorr[ipl][is]) ;
 }}
 //
 ...
 tsimc->SetBranchAddress("T.coin.hSTOF_ROC1_tdcTimeRaw",&hSTOF_ROC1_tdcTimeRaw);
 Double_t  hSTOF_ROC2_tdcTimeRaw;
 tsimc->SetBranchAddress("T.coin.hSTOF_ROC2_tdcTimeRaw",&hSTOF_ROC2_tdcTimeRaw);
 Double_t  pPRE40_ROC1_tdcTimeRaw;
 tsimc->SetBranchAddress("T.coin.pPRE40_ROC1_tdcTimeRaw",&pPRE40_ROC1_tdcTimeRaw);
 Double_t  hPRE40_ROC2_tdcTimeRaw;
 tsimc->SetBranchAddress("T.coin.hPRE40_ROC2_tdcTimeRaw",&hPRE40_ROC2_tdcTimeRaw);
 ...
 Double_t  hT1_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.hT1_tdcTimeRaw",&hT1_tdcTimeRaw);
 Double_t  hT2_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.hT2_tdcTimeRaw",&hT2_tdcTimeRaw);
 Double_t  h1X_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.h1X_tdcTimeRaw",&h1X_tdcTimeRaw);
 Double_t  h1Y_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.h1Y_tdcTimeRaw",&h1Y_tdcTimeRaw);
 Double_t  h2X_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.h2X_tdcTimeRaw",&h2X_tdcTimeRaw);
 Double_t  h2Y_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.h2Y_tdcTimeRaw",&h2Y_tdcTimeRaw);
 Double_t  p1X_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.p1X_tdcTimeRaw",&p1X_tdcTimeRaw);
 Double_t  p1Y_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.p1Y_tdcTimeRaw",&p1Y_tdcTimeRaw);
 Double_t  p2X_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.p2X_tdcTimeRaw",&p2X_tdcTimeRaw);
 Double_t  p2Y_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.p2Y_tdcTimeRaw",&p2Y_tdcTimeRaw);
 ...
 Double_t  hTRIG1_ROC1_tdcTimeRaw;
   tsimc->SetBranchAddress("T.coin.hTRIG1_ROC1_tdcTimeRaw",&hTRIG1_ROC1_tdcTimeRaw);
 ...
 Double_t  pfptime;
 Double_t  hfptime;
   tsimc->SetBranchAddress("P.hod.fpHitsTime",&pfptime);
 ...
 Double_t  hstarttime;
   ...
   HList.Add(haero_cut);
    ...
    HList.Add(hCTcalc);
    TH1F *hCTcalc_all = new TH1F("hCTcalc_all",Form("Run %d ; CT Calc  ;Counts",nrun),80, 20.,40.0);
    HList.Add(hCTcalc_all);
    TH1F *hCTcalc_all1 = new TH1F("hCTcalc_all1",Form("Run %d ; CT Calc 1  ;Counts",nrun),80, 20.,40.0);
    HList.Add(hCTcalc_all1);
    TH1F *hCTcalc_all2 = new TH1F("hCTcalc_all2",Form("Run %d ; CT Calc 2  ;Counts",nrun),80, 20.,40.0);
    HList.Add(hCTcalc_all2);
    TH1F *hCTcalc_all3 = new TH1F("hCTcalc_all3",Form("Run %d ; CT Calc 3  ;Counts",nrun),120, 20.,40.0);
    HList.Add(hCTcalc_all3);
    TH2F *hCTcalc_all2_sdiff = new TH2F("hCTcalc_all2_sdiff",Form("Run %d ; CT Calc 2  ; Start time diff",nrun),80, 20.,40.0,200,-10,40);
    HList.Add(hCTcalc_all2_sdiff);
    TH2F *hCTcalc_all2_ptrig1 = new TH2F("hCTcalc_all2_ptrig1",Form("Run %d ; CT Calc 2  ; Ptrig1",nrun),80, 20.,40.0,80,380,400);
    HList.Add(hCTcalc_all2_ptrig1);
    TH2F *hCTcalc_all2_pdelta = new TH2F("hCTcalc_all2_pdelta",Form("Run %d ; CT Calc 2  ; Pdelta",nrun),80, 20.,40.0,200,-10,20);
    HList.Add(hCTcalc_all2_pdelta);
    TH2F *hCTcalc_all_hxfp = new TH2F("hCTcalc_all_hxfp",Form("Run %d ; CT calc  ; HMS xfp",nrun),80, 20.,40.0,90,-50,40);
    HList.Add(hCTcalc_all_hxfp);
    TH2F *hCTcalc_all_hyfp = new TH2F("hCTcalc_all_hyfp",Form("Run %d ; CT calc  ; HMS yfp",nrun),80, 20.,40.0,40,-20,20);
    HList.Add(hCTcalc_all_hyfp);
     TH2F *hCTcalc3_all_hxfp = new TH2F("hCTcalc3_all_hxfp",Form("Run %d ; CT calc3  ; HMS xfp",nrun),80, 20.,40.0,90,-50,40);
    HList.Add(hCTcalc3_all_hxfp);
    TH2F *hCTcalc3_all_hyfp = new TH2F("hCTcalc3_all_hyfp",Form("Run %d ; CT calc3  ; HMS yfp",nrun),80, 20.,40.0,40,-20,20);
    HList.Add(hCTcalc3_all_hyfp);
   TH1F *hhbetatof = new TH1F("hhbetatof",Form("Run %d ; HMS TOF (ns) using Hod Beta  ; Counts",nrun),40, 8. ,12.);
    HList.Add(hhbetatof);
   TH1F *hpbetatof = new TH1F("hpbetatof",Form("Run %d ; SHMS TOF (ns) using Hod Beta  ; Counts",nrun),40, 5. ,10.);
    HList.Add(hpbetatof);
     TH2F *hhbetatof_hxfp = new TH2F("hhbetatof_hxfp",Form("Run %d ; HMS TOF (ns) using Hod Beta  ; HMS xfp",nrun),40, 8. ,12.,90,-50,40);
    HList.Add(hhbetatof_hxfp);
    TH2F *hhbetatof_hyfp = new TH2F("hhbetatof_hyfp",Form("Run %d ; HMS TOF (ns) using Hod Beta   ; HMS yfp",nrun),40, 8. ,12,40,-20,20);
    HList.Add(hhbetatof_hyfp);
    TH1F *hepiCoinTime_ROC2_cut = new TH1F("hepicoinTime_ROC2_cut",Form("Run %d ; epiCoinTimeW_ROC2  ;Counts",nrun),800, 0.,100.0);
    HList.Add(hepiCoinTime_ROC2_cut);
   ...
   TH1F *hpRFraw = new TH1F("hpRFraw",Form("Run %d ; pRF raw;Counts",nrun),1000, 0.,10000.0);
    HList.Add(hpRFraw);
   TH1F *hhRFraw = new TH1F("hhRFraw",Form("Run %d ; hRF raw;Counts",nrun),1000, 0.,10000.0);
    HList.Add(hhRFraw);
   TH1F *hpRF = new TH1F("hpRF",Form("Run %d ; pRF ;Counts",nrun),2000, -500.,500.0);
    HList.Add(hpRF);
   TH1F *hhRF = new TH1F("hhRF",Form("Run %d ; hRF ;Counts",nrun),2000, -500.,500.0);
    HList.Add(hhRF);
       TH1F *hhRF_hstart = new TH1F("hhRF_hstart",Form("Run %d ; hRF -hstart ;Counts",nrun),200, 0.,50.0);
       TH1F *hhRF_hstart_stof = new TH1F("hhRF_hstart_stof",Form("Run %d ; hRF-hstof -hstart ;Counts",nrun),200, 0.,50.0);
       TH1F *hhRF_hstart_2 = new TH1F("hhRF_hstart_2",Form("Run %d ; hRF -hstart ;Counts",nrun),3200, -400.,400.0);
       TH1F *hhRF_hsx1fp = new TH1F("hhRF_hsx1fp",Form("Run %d ; hRF -hs1xfptime ;Counts",nrun),200, 0.,50.0);
       TH1F *hhRF_hsy1fp = new TH1F("hhRF_hsy1fp",Form("Run %d ; hRF -hs1yfptime ;Counts",nrun),200, 0.,50.0);
       TH1F *hhRF_hsx2fp = new TH1F("hhRF_hsx2fp",Form("Run %d ; hRF -hs2xfptime ;Counts",nrun),200, 0.,50.0);
       TH1F *hhRF_hsy2fp = new TH1F("hhRF_hsy2fp",Form("Run %d ; hRF -hs2yfptime ;Counts",nrun),200, 0.,50.0);
    //   TH1F *hhRF_hstart = new TH1F("hhRF_hstart",Form("Run %d ; hRF -hstart ;Counts",nrun),2400, -300.,300.0);
    HList.Add(hhRF_hstart);
    HList.Add(hhRF_hstart_2);
    HList.Add(hhRF_hstart_stof);
    TH2F *hhRFhstart_hxfp = new TH2F("hhRFhstart_hxfp",Form("Run %d ; hRF -hstart   ; HMS xfp",nrun),200, 0.,50.0,90,-50,40);
    HList.Add(hhRFhstart_hxfp);
    TH2F *hhRFhstart_hyfp = new TH2F("hhRFhstart_hyfp",Form("Run %d ; hRF -hstart   ; HMS yfp",nrun),200, 0.,50.0,80,-20,20);
    HList.Add(hhRFhstart_hyfp);
   TH2F *hhRFhstart_hstart = new TH2F("hhRFhstart_hstart",Form("Run %d ; hRF -hstart   ; HMS start",nrun),40, 40.,50.0,40,20,30);
    HList.Add(hhRFhstart_hstart);

    TH1F *hps1x_t2_diff = new TH1F("hps1x_t2_diff",Form("Run %d ; ps1x_ROC2 - pT2_ROC2 ;Counts",nrun),120,180.,210.);
    HList.Add(hps1x_t2_diff);
    TH1F *hps1y_t2_diff = new TH1F("hps1y_t2_diff",Form("Run %d ; ps1y_ROC2 - pT2_ROC2 ;Counts",nrun),120,180.,210.);
    HList.Add(hps1y_t2_diff);
     TH1F *hps2x_t2_diff = new TH1F("hps2x_t2_diff",Form("Run %d ; ps2x_ROC2 - pT2_ROC2 ;Counts",nrun),120,180.,210.);
    HList.Add(hps2x_t2_diff);
    TH1F *hps2y_t2_diff = new TH1F("hps2y_t2_diff",Form("Run %d ; ps2y_ROC2 - pT2_ROC2 ;Counts",nrun),120,180.,210.);
    HList.Add(hps2y_t2_diff);
  
  TH1F *hps1x_pre40_diff = new TH1F("hps1x_pre40_diff",Form("Run %d ; ps1x_ROC2 - pPRE40_ROC2 ;Counts",nrun),120,60.,90.);
    HList.Add(hps1x_pre40_diff);
    TH1F *hps1y_pre40_diff = new TH1F("hps1y_pre40_diff",Form("Run %d ; ps1y_ROC2 - pPRE40_ROC2 ;Counts",nrun),120,60.,90.);
    HList.Add(hps1y_pre40_diff);
     TH1F *hps2x_pre40_diff = new TH1F("hps2x_pre40_diff",Form("Run %d ; ps2x_ROC2 - pPRE40_ROC2 ;Counts",nrun),120,60.,90.);
    HList.Add(hps2x_pre40_diff);
    TH1F *hps2y_pre40_diff = new TH1F("hps2y_pre40_diff",Form("Run %d ; ps2y_ROC2 - pPRE40_ROC2 ;Counts",nrun),120,60.,90.);
    HList.Add(hps2y_pre40_diff);

    TH1F *hhs1x_t1_diff = new TH1F("hhs1x_t1_diff",Form("Run %d ; hs1x_ROC1 - hT1_ROC1 ;Counts",nrun),120,220.,250.);
    HList.Add(hhs1x_t1_diff);
    TH1F *hhs1y_t1_diff = new TH1F("hhs1y_t1_diff",Form("Run %d ; hs1y_ROC1 - hT1_ROC1 ;Counts",nrun),120,220.,250.);
    HList.Add(hhs1y_t1_diff);
     TH1F *hhs2x_t1_diff = new TH1F("hhs2x_t1_diff",Form("Run %d ; hs2x_ROC1 - hT1_ROC1 ;Counts",nrun),120,220.,250.);
    ...
    TH1F *hhs1x_stof_diff = new TH1F("hhs1x_stof_diff",Form("Run %d ; hs1x_ROC1 - hSTOF_ROC1 ;Counts",nrun),120,285.,315.);
    HList.Add(hhs1x_stof_diff);
    TH2F *hhs1x_s1y_stof_diff = new TH2F("hhs1x_s1y_stof_diff",Form("Run %d ; hs1x_ROC1 - hSTOF_ROC1 ; hs1y_ROC1 - hSTOF_ROC1",nrun),120,285.,315.,120,285.,315.);
    HList.Add(hhs1x_s1y_stof_diff);
    TH2F *hhs1x_s2x_stof_diff = new TH2F("hhs1x_s2x_stof_diff",Form("Run %d ; hs1x_ROC1 - hSTOF_ROC1 ; hs2x_ROC1 - hSTOF_ROC1",nrun),120,285.,315.,120,285.,315.);
    HList.Add(hhs1x_s2x_stof_diff);
    TH2F *hhs1x_s2y_stof_diff = new TH2F("hhs1x_s2y_stof_diff",Form("Run %d ; hs1x_ROC1 - hSTOF_ROC1 ; hs2y_ROC1 - hSTOF_ROC1",nrun),120,285.,315.,120,285.,315.);
    HList.Add(hhs1x_s2y_stof_diff);
    TH1F *hhs1y_stof_diff = new TH1F("hhs1y_stof_diff",Form("Run %d ; hs1y_ROC1 - hSTOF_ROC1 ;Counts",nrun),120,285.,315.);
    HList.Add(hhs1y_stof_diff);
     TH1F *hhs2x_stof_diff = new TH1F("hhs2x_stof_diff",Form("Run %d ; hs2x_ROC1 - hSTOF_ROC1 ;Counts",nrun),120,285.,315.);
    HList.Add(hhs2x_stof_diff);
    TH1F *hhs2y_stof_diff = new TH1F("hhs2y_stof_diff",Form("Run %d ; hs2y_ROC1 - hSTOF_ROC1 ;Counts",nrun),120,285.,315.);
    HList.Add(hhs2y_stof_diff);
   ...
   TH1F *hpPRE40_t2_diff = new TH1F("hpPRE40_t2_diff",Form("Run %d ; pPRE40_ROC1 - pT2_ROC2 ;Counts",nrun),160,400.,440.);
    HList.Add(hpPRE40_t2_diff);

   TH1F *hpRF_pstart = new TH1F("hpRF_pstart",Form("Run %d ; pRF -pstart ;Counts",nrun),200, 0.,50.0);
    HList.Add(hpRF_pstart);
   TH1F *hpRF_pstart_2 = new TH1F("hpRF_pstart_2",Form("Run %d ; pRF -pstart ;Counts",nrun),200, 0.,50.0);
    HList.Add(hpRF_pstart_2); 
   tsimc->SetBranchAddress("T.coin.hT1_tdcTimeRaw",&hT1_tdcTimeRaw);

   TH1F *hpRF_ptrig1 = new TH1F("hpRF_ptrig1",Form("Run %d ; pRF -ptrig1 ;Counts",nrun),200, 0.,50.0);
    HList.Add(hpRF_ptrig1);
   TH1F *hpRF_ptrig4 = new TH1F("hpRF_ptrig4",Form("Run %d ; pRF -ptrig4 ;Counts",nrun),200, 0.,50.0);
    HList.Add(hpRF_ptrig4);
   TH1F *hpRF_htrig1 = new TH1F("hpRF_htrig1",Form("Run %d ; pRF -htrig1 ;Counts",nrun),200, 0.,50.0);
    HList.Add(hpRF_htrig1);
    TH1F *hptrig1_ROC2 ;
    TH1F *hptrig1_ROC2_raw ;
       hptrig1_ROC2_raw   = new TH1F("hptrig1_ROC2_raw",Form("Run %d ; ptrig1_ROC2  ;Counts",nrun),40., 388.,398.0);
     TH1F *hptrig1_ROC2_diffpPre40 = new TH1F("hptrig1_ROC2_diffpPre40",Form("Run %d ; ptrig1_ROC2 using pPre40 ;Counts",nrun),80, 265.,275.0);
    HList.Add(hptrig1_ROC2_diffpPre40);
   TH1F *hptrig4_ROC2 ;
    TH1F *hhtrig1_ROC1 ;
    TH1F *hhtrig1_ROC1_raw ;
   TH1F *hhtrig1_t1_diff_ROC1 = new TH1F("hhtrig1_t1_diff_ROC1",Form("Run %d ; htrig1-ht1 ;Counts",nrun),40, 320.,330.0);
    HList.Add(hhtrig1_t1_diff_ROC1);
   TH1F *hhtrig1_ptrig4_diff_ROC2 = new TH1F("hhtrig1_ptrig4_diff_ROC2",Form("Run %d ; htrig1 - ptrig4 (ROC2) ;Counts",nrun),160, 100.,120.0);
    HList.Add(hhtrig1_ptrig4_diff_ROC2);
    if (nrun<4000) {
       ...
       hhtrig1_ROC1_raw = new TH1F("hhtrig1_ROC1_raw",Form("Run %d ; htrig1_ROC1raw (HMS trig in HMS ROC)  ;Counts",nrun),800, 0.,5000.0);
      hhtrig1_ROC1 = new TH1F("hhtrig1_ROC1",Form("Run %d ; htrig1_ROC1 (HMS trig in HMS ROC)  ;Counts",nrun),800, 0.,500.0);
    } else {
    ...
    HList.Add(hhtrig1_ROC1_raw);
    HList.Add(hhtrig1_ROC1);
   ...
   TH1F *hptrig1raw_ROC2 = new TH1F("hptrig1raw_ROC2",Form("Run %d ; ptrig1raw_ROC2 (SHMS trig in SHMS ROC) ;Counts",nrun),1000, 0.,10000.0);
    ...
    TH2F *hptrig4_ptrig1_ROC2_cut = new TH2F("hptrig4_ptrig1_ROC2_cut",Form("Run %d ; ptrig4_ROC2 ; ptrig1_ROC2 ",nrun),200, 350.,450.0,200, 350.,450.0);
    HList.Add(hptrig4_ptrig1_ROC2_cut);
    ...
    //     TH2F *hptrig4_ptrigdiff_ROC1_cut = new TH2F("hptrig4_ptrigdiff_ROC1_cut",Form("Run %d ; ptrig4_ROC1 (HMS trig in SHMS ROC)  ; T4-t1 ",nrun),200, 260.,360.0,200, -20.,20.0);
       TH2F *hptrig4_ptrigdiff_ROC2_cut = new TH2F("hptrig4_ptrigdiff_ROC2_cut",Form("Run %d ; ptrig4_ROC2 (HMS trig in SHMS ROC)  ; T4-t1 ",nrun),200, 100.,500.0,200, -20.,20.0);
    HList.Add(hptrig4_ptrigdiff_ROC2_cut);
       TH2F *hptrig1_ptrigdiff_ROC2_cut = new TH2F("hptrig1_ptrigdiff_ROC2_cut",Form("Run %d ; ptrig1_ROC2 (SHMS trig in SHMS ROC)  ; T4-t1 ROC2 ",nrun),1200, 200.,500.0,200, -20.,20.0);
    HList.Add(hptrig1_ptrigdiff_ROC2_cut);
 ...
 TH1F *hadc_pulsetime[plnum][iside][16];
 TH2F *hadc_pulsetime_pm[plnum][16];
 for (Int_t ipl=0;ipl<plnum;ipl++) {
 for (Int_t ipad=0;ipad<npad[ipl];ipad++) {
   ...
   hadc_pulsetime_pm[ipl][ipad]= new TH2F(Form("hadc_pulsetime_pm_%s_pad_%d",plname[ipl],ipad),Form("%s pad_%d; HMS ADC time POS ; HMS ADC time NEG",plname[ipl],ipad),120,65,95,120,65.,95.);
   HList.Add(hadc_pulsetime_pm[ipl][ipad]);
 for (Int_t is=0;is<iside;is++) {
   hadc_pulsetime[ipl][is][ipad]= new TH1F(Form("hadc_pulsetime_%s_%s_pad_%d",plname[ipl],sidename[is],ipad),Form("%s %s pad_%d; HMS ADC time ;counts",plname[ipl],sidename[is],ipad),120,65.,95.);
   HList.Add(hadc_pulsetime[ipl][is][ipad]);
 ...
 for (Int_t ipl=0;ipl<plnum;ipl++) {
 for (Int_t ipad=0;ipad<npad[ipl];ipad++) {
   htdc_cut_uncorr_pm[ipl][ipad]= new TH2F(Form("tdc_cut_uncorr_pm_%s_pad_%d",plname[ipl],ipad),Form("Cut S1x time %s pad_%d; HMS TDC POS ; HMS TDC NEG",plname[ipl],ipad),120,20,200,120,20,200.);
   HList.Add(htdc_cut_uncorr_pm[ipl][ipad]);
 for (Int_t is=0;is<iside;is++) {
   htdc_cut_uncorr[ipl][is][ipad]= new TH1F(Form("tdc_cut_uncorr_%s_%s_pad_%d",plname[ipl],sidename[is],ipad),Form("Cut s1x time %s %s pad_%d; HMS TDc uncorr;counts",plname[ipl],sidename[is],ipad),120,20,200.);
 ...
 TH2F *hRF_hmspad_tdiff_xpos[4][2][16];
 TH2F *hRF_hmspad_tdiff_ypos[4][2][16];
                  for (Int_t ipl=0;ipl<plnum;ipl++) {
                   for (Int_t ipad=0;ipad<npad[ipl];ipad++) {
                     for (Int_t is=0;is<iside;is++) {
		       hRF_hmspad_tdiff[ipl][is][ipad] = new TH1F(Form("hRF_hmspad_tdiff_%s_%s_pad_%d",plname[ipl],sidename[is],ipad),Form("%s %s pad_%d; hRF - pad TOF ; Counts",plname[ipl],sidename[is],ipad),48,19,31);
		       hRF_hmspad_tdiff_xpos[ipl][is][ipad] = new TH2F(Form("hRF_hmspad_tdiff_x_%s_%s_pad_%d",plname[ipl],sidename[is],ipad),Form("%s %s pad_%d; hRF - pad TOF ; X",plname[ipl],sidename[is],ipad),48,19,31,60,-60,60);
		       hRF_hmspad_tdiff_ypos[ipl][is][ipad] = new TH2F(Form("hRF_hmspad_tdiff_y_%s_%s_pad_%d",plname[ipl],sidename[is],ipad),Form("%s %s pad_%d; hRF - pad TOF ; Y",plname[ipl],sidename[is],ipad),48,19,31,30,-30,30);
		   }}}
 TH1F *hRF_shmspad_tdiff[4][2][21];
                  for (Int_t ipl=0;ipl<plnum;ipl++) {
                   for (Int_t ipad=0;ipad<npadshms[ipl];ipad++) {
                     for (Int_t is=0;is<iside;is++) {
		       hRF_shmspad_tdiff[ipl][is][ipad] = new TH1F(Form("hRF_shmspad_tdiff_%s_%s_pad_%d",plname[ipl],sidename[is],ipad),Form("%s %s pad_%d; pRF - shms pad TOF ; Counts",plname[ipl],sidename[is],ipad),48,19,31);
		     }}} 
...
// loop over entries
	...
	for (int ie = 0; ie < nentries; ie++) {
		...
		Double_t CT_calc=(pTRIG1_ROC2_tdcTime-pTRIG4_ROC2_tdcTime)+(pstarttime-hstarttime);
		Double_t CT_calc1=0.09766*((pTRIG1_ROC1_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw))+(pstarttime-hstarttime)-150;
		//Double_t CT_calc2=(391-hTRIG1_ROC2_tdcTime-100)+(pstarttime-hstarttime);
 		Double_t CT_calc2=0.09766*((pTRIG1_ROC2_tdcTimeRaw-hPRE40_ROC2_tdcTimeRaw))+(pstarttime-hstarttime)-75;
		Double_t CT_calc3=0.09766*((pTRIG1_ROC2_tdcTimeRaw-hSTOF_ROC2_tdcTimeRaw))+(pstarttime-hstarttime)-150;
		hpbetanotrack->Fill(betanotrack);
		haero->Fill(paero);
		hptrig1raw_ROC2->Fill(pTRIG1_ROC2_tdcTimeRaw);
 		hptrig4raw_ROC2->Fill(pTRIG4_ROC2_tdcTimeRaw);
		if (pntr>0 && hntr >0) haero_cut->Fill(paero);
		if (nrun==3288) selcut=pntr>0 && hntr >0;
		if (nrun==6560) selcut=kTRUE;
		if (nrun==6634) selcut=pntr>0 && hntr >0;
		if (selcut) {
		  hht2_raw->Fill(hT2_tdcTimeRaw); 
		  ...
		  Double_t rfhstof=0.09766*(hRF_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+200.;
                for (Int_t ipl=0;ipl<plnum;ipl++) {
                   for (Int_t ipad=0;ipad<npad[ipl];ipad++) {
		    ...
		    hshmstdc_uncorr[ipl][is][ipad]->Fill(shmstdc_uncorr[ipl][is][ipad]);
		  }}}
		  
		 hCTcalc_all->Fill(CT_calc);
		 hCTcalc_all1->Fill(CT_calc1);
		 hCTcalc_all2->Fill(CT_calc2);
		 hCTcalc_all3->Fill(CT_calc3);
                  hCTcalc_all_hxfp->Fill(CT_calc2,hxfp);
                  hCTcalc_all_hyfp->Fill(CT_calc2,hyfp);
                  hCTcalc3_all_hxfp->Fill(CT_calc3,hxfp);
                  hCTcalc3_all_hyfp->Fill(CT_calc3,hyfp);
                  hpbetatof->Fill(200./pbetatrack/30.);
                  hhbetatof->Fill(300./hbetatrack/30.);
                  hhbetatof_hxfp->Fill(300./hbetatrack/30.,hxfp);
                  hhbetatof_hyfp->Fill(300./hbetatrack/30.,hyfp);
                  hCTcalc_all2_sdiff->Fill(CT_calc2,(pstarttime-hstarttime));
                  hCTcalc_all2_pdelta->Fill(CT_calc2,delta);
                  hCTcalc_all2_ptrig1->Fill(CT_calc2,pTRIG1_ROC2_tdcTime);
		  hhtrig1_ptrig4_diff_ROC2->Fill(pTRIG4_ROC2_tdcTime-hTRIG1_ROC2_tdcTime);
		  hpRFraw->Fill(pRF_tdcTimeRaw);
		  hpRF->Fill(pRF_tdcTime);
		  hhRFraw->Fill(hRF_tdcTimeRaw);
		  hhRF->Fill(0.09766*(hRF_tdcTimeRaw-hT1_tdcTimeRaw)+300.);
		  hhPRE40_t1_diff->Fill(0.09766*(hPRE40_ROC1_tdcTimeRaw-hT1_tdcTimeRaw)+300.);
	  hhs1x_t1_diff->Fill(0.09766*(h1X_tdcTimeRaw-hT1_tdcTimeRaw)+300.);
		  ...
		  hhs1x_stof_diff->Fill(0.09766*(h1X_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  hhs1x_s1y_stof_diff->Fill(0.09766*(h1X_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.,0.09766*(h1Y_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  hhs1x_s2x_stof_diff->Fill(0.09766*(h1X_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.,0.09766*(h2X_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  hhs1x_s2y_stof_diff->Fill(0.09766*(h1X_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.,0.09766*(h2Y_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  hhs1y_stof_diff->Fill(0.09766*(h1Y_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  hhs2x_stof_diff->Fill(0.09766*(h2X_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  hhs2y_stof_diff->Fill(0.09766*(h2Y_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+360.);
		  //                if ((TMath::Abs(0.09766*(h1X_tdcTimeRaw-hPRE40_ROC1_tdcTimeRaw)+360.-227.75)<0.25)) {

		                if ((TMath::Abs(0.09766*(h1X_tdcTimeRaw-hPRE40_ROC1_tdcTimeRaw)+360.-228.25)<0.25)) {
		  ...
		  hhs2y_s1xsettime_pre40_diff->Fill(0.09766*(h2Y_tdcTimeRaw-hPRE40_ROC1_tdcTimeRaw)+360.);
 		     ...
 		     hadc_pulsetime_pm[ipl][ipad]->Fill(hmsadc_time[ipl][1][ipad],hmsadc_time[ipl][0][ipad]);
                    for (Int_t is=0;is<iside;is++) {
		    htdc_cut_uncorr[ipl][is][ipad]->Fill(tdc_uncorr[ipl][is][ipad]);
		    hadc_pulsetime[ipl][is][ipad]->Fill(hmsadc_time[ipl][is][ipad]);
		   }}}
		  }

		  hps1x_t2_diff->Fill(0.09766*(p1X_tdcTimeRaw-pT2_tdcTimeRaw)+300.);
		  hps1y_t2_diff->Fill(0.09766*(p1Y_tdcTimeRaw-pT2_tdcTimeRaw)+300.);
		  hps2x_t2_diff->Fill(0.09766*(p2X_tdcTimeRaw-pT2_tdcTimeRaw)+300.);
		  hps2y_t2_diff->Fill(0.09766*(p2Y_tdcTimeRaw-pT2_tdcTimeRaw)+300.);

		  hps1x_pre40_diff->Fill(0.09766*(p1X_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+300.);
		  hps1y_pre40_diff->Fill(0.09766*(p1Y_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+300.);
		  hps2x_pre40_diff->Fill(0.09766*(p2X_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+300.);
		  hps2y_pre40_diff->Fill(0.09766*(p2Y_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+300.);

		  hpPRE40_t2_diff->Fill(0.09766*(pPRE40_ROC2_tdcTimeRaw-pT2_tdcTimeRaw)+300.);
		  Double_t rfhdiff=0.09766*(hRF_tdcTimeRaw-hT1_tdcTimeRaw)+200.-hstarttime;
		  Double_t rfhdiffstof=0.09766*(hRF_tdcTimeRaw-hSTOF_ROC1_tdcTimeRaw)+200.-hstarttime;
		  hhRF_hstart->Fill(rfhdiff);
		  hhRF_hstart_2->Fill(rfhdiff);
		  hhRF_hstart_stof->Fill(rfhdiffstof);
		  hhRF_hsx1fp->Fill(rfhdiff-hs1xfptime);
		  hhRF_hsy1fp->Fill(rfhdiff-hs1yfptime);
		  hhRF_hsx2fp->Fill(rfhdiff-hs2xfptime);
		  hhRF_hsy2fp->Fill(rfhdiff-hs2yfptime);
		  hhRFhstart_hstart->Fill(rfhdiff-hstarttime,hstarttime);
		  hhRFhstart_hxfp->Fill(rfhdiff-hstarttime,hxfp);
		  hhRFhstart_hyfp->Fill(rfhdiff-hstarttime,hyfp);
		  Double_t rfpdiff=0.09766*(pRF_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+200.;
		  hpRF_pstart->Fill(pRF_tdcTime-pstarttime);
		  hpRF_pstart_2->Fill(rfpdiff-pstarttime);
		  hpRF_ptrig1->Fill(pRF_tdcTime-pTRIG1_ROC2_tdcTime+400);
		  hpRF_ptrig4->Fill(pRF_tdcTime-pTRIG4_ROC2_tdcTime+400);
		  hpRF_htrig1->Fill(pRF_tdcTime-hTRIG1_ROC2_tdcTime+400);
		...
		hps1xfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,ps1xfptime);
		hps2xfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,ps2xfptime);
		hps1yfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,ps1yfptime);
		hps2yfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,ps2yfptime);
		hhs1xfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,hs1xfptime);
		hhs2xfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,hs2xfptime);
		hhs1yfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,hs1yfptime);
		hhs2yfptime_trig14diff->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,hs2yfptime);

		hps1xfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,ps1xfptime);
		hps2xfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,ps2xfptime);
		hps1yfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,ps1yfptime);
		hps2yfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,ps2yfptime);
		hhs1xfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,hs1xfptime);
		hhs2xfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,hs2xfptime);
		hhs1yfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,hs1yfptime);
		hhs2yfptime_trig14diffraw->Fill((pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw)*.0976,hs2yfptime);
		...
		hptrig1_ROC2_raw->Fill(0.09766*(pTRIG1_ROC2_tdcTimeRaw-pT2_tdcTimeRaw)+300.);
		hptrig1_ROC2_diffpPre40->Fill(0.09766*(pTRIG1_ROC2_tdcTimeRaw-pPRE40_ROC2_tdcTimeRaw)+300.);
		hhtrig1_ROC1->Fill(hTRIG1_ROC1_tdcTime);
		hhtrig1_ROC1_raw->Fill(hTRIG1_ROC1_tdcTimeRaw);
		hhtrig1_t1_diff_ROC1->Fill(0.09766*(hTRIG1_ROC1_tdcTimeRaw-hT1_tdcTimeRaw)+300.);
 		hptrig4_ROC2->Fill(pTRIG4_ROC2_tdcTime);
		hptrig4_ptrig1_ROC1_cut->Fill(pTRIG4_ROC1_tdcTime,pTRIG1_ROC1_tdcTime);
		  hptrig4_ptrig1_ROC2_cut->Fill(pTRIG4_ROC2_tdcTime,pTRIG1_ROC2_tdcTime);
		  hptrig4_ptrigdiff_ROC2_cut->Fill(pTRIG4_ROC1_tdcTime,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		  ...
		  hptrig14diff_starttimediff_ROC1_cut->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,pstarttime-hstarttime);
		  if (TMath::Abs(pTRIG1_ROC2_tdcTime-391.9)< 0.1) {
                        hptrig14diff_starttimediff_cut1->Fill(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime,pstarttime-hstarttime);
		  }
		  ...
		  hptrig14diffroc2->Fill(0.09766*(pTRIG4_ROC2_tdcTimeRaw-pTRIG1_ROC2_tdcTimeRaw));
		  if (TMath::Abs(pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime-5.75)<0.5 && TMath::Abs(pstarttime-hstarttime-18)<2) {
		  hpxfp_ptrigdiff_ROC1_cut->Fill(pxfp,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		  hpyfp_ptrigdiff_ROC1_cut->Fill(pyfp,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		  hhxfp_ptrigdiff_ROC1_cut->Fill(hxfp,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		  hhyfp_ptrigdiff_ROC1_cut->Fill(hyfp,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		  }
		  //}
		...
		hepiCoinTime_ptrig14diff->Fill(ePiCoinTime_ROC2,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		hCTcalc_ptrig14diff->Fill(CT_calc,pTRIG4_ROC2_tdcTime-pTRIG1_ROC2_tdcTime);
		...
		hepiCoinTime_ptrig14diff_roc1->Fill(ePiCoinTime_ROC1,pTRIG4_ROC1_tdcTime-pTRIG1_ROC1_tdcTime);
                if (TMath::Abs(pTRIG1_ROC2_tdcTime-391.9)< 0.1) hepiCoinTime_ROC2_cut->Fill(ePiCoinTime_ROC2);
