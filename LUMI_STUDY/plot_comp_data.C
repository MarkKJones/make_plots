...
gStyle->SetPalette(1,0);
 ...
 gStyle->SetPadLeftMargin(0.16);
   TString outputpdf;
   outputpdf= "plots/lumi_ld2_coin.pdf";
   ...
   Long64_t nlines = T->ReadFile("LUMI_STUDY/ld2_coin_scal.dat","nrun/D:ch/D:curthres:avecur:ptime:trig1rate:trig2rate:trig3rate:trig4rate:trig1yield:trig1yielderr:trig2yield:trig2yielderr:trig3yield:trig3yielderr:trig4yield:trig4yielderr");
  ...
  legt2->SetFillColor(0);
   legt2->AddEntry(gr_trig2_low," SHMS ELREAL I > 1.5","p");
  legt2->AddEntry(gr_trig2," SHMS ELREAL I > near max","p");
  TCanvas *ctrig2 = new TCanvas("ctrig2"," trig2",700,700);
   ctrig2->Divide(1,1);
   ctrig2->cd(1);
   mgt2->Draw("AP");
   mgt2->SetTitle("LD2 COin ; Current; TRIG2 SHMS Yield ");
   mgt2->SetMaximum(max_trig2*1.05);
   mgt2->SetMinimum(max_trig2*0.95);
     legt2->Draw();
  ...
  legt3->SetFillColor(0);
   legt3->AddEntry(gr_trig3_low," HMS ELREAL I > 1.5","p");
  legt3->AddEntry(gr_trig3," HMS ELREAL I > near max","p");
  TCanvas *ctrig3 = new TCanvas("ctrig3"," trig3",700,700);
   ctrig3->Divide(1,1);
   ctrig3->cd(1);
   mgt3->Draw("AP");
   mgt3->SetTitle("LD2 COin; Current; TRIG3 HMS Yield ");
   mgt3->SetMaximum(max_trig3*1.05);
   mgt3->SetMinimum(max_trig3*0.95);
    legt3->Draw();
  ...
  leg1->AddEntry(gr_rat_trig2_low," SHMS ELREAL I > 1.5","p");
  ...
  leg1->AddEntry(gr_rat_trig3_low,"  HMS ELREAL I > 1.5","p");
  }
  ...
  leg1->SetFillColor(0);
  leg1->AddEntry(gr_rat_trig2," SHMS ELREAL I > near max","p");
  leg1->AddEntry(gr_rat_trig3,"  HMS ELREAL I > near max","p");
  TCanvas *cplot = new TCanvas("cplot"," ratio",700,700);
   cplot->Divide(1,1);
   cplot->cd(1);
   mg1->Draw("AP");
   mg1->SetTitle("LD2 Coin ; Current; Relative Yield ");
