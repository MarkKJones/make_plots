...
gStyle->SetPalette(1,0);
 ...
 gStyle->SetPadLeftMargin(0.16);
   TString outputpdf;
   outputpdf= "plots/lumi_jpsi_phase4_shms.pdf";
   ...
   Double_t trig1rate,trig2rate,trig3rate,trig4rate,trig1yield,trig1yielderr,trig2yield,trig2yielderr,trig3yield,trig3yielderr,trig4yield,trig4yielderr,datayield,datayielderr;
      Long64_t nlines = T->ReadFile("LUMI_STUDY/lumi_jpsi_phase4_shms.dat","nrun/D:ch/D:curthres:avecur:ptime:trig2rate:trig4rate:datarate:trig2yield:trig2yielderr:trig4yield:trig4yielderr:datayield:datayielderr");
  ...
  legt3->SetFillColor(0);
   legt3->AddEntry(gr_trig4," SHMS trgi 4 ELCLEAN I > 1.5","p");
