...
gStyle->SetPalette(1,0);
 ...
 gStyle->SetPadLeftMargin(0.12);
   ...
   TString outputhist;
   outputhist= "hist/"+basename+"_hms_ep_hist.root";
 TObjArray HList(0);
 //
...
// Define branches
 ...
 Double_t  aero;
   tsimc->SetBranchAddress("P.aero.npeSum",&aero);
 Double_t  gindex;
 ...
 Double_t  ThScat;
   ...
   // Define histograms
    ...
    HList.Add(hW);
    TH1F *hW_prot = new TH1F("hW_prot",Form("Run %d ; W (GeV) protons;Counts",nrun), 100, 0.8,2.0);
    HList.Add(hW_prot);
    ...
    HList.Add(hPmiss);
    TH1F *hMmiss2 = new TH1F("hMmiss2",Form("Run %d ; Mmiss2 (GeV2);Counts",nrun), 200, -.05,2.);
    HList.Add(hMmiss2);
    TH1F *hMmiss2_prot= new TH1F("hMmiss2_prot",Form("Run %d ; Mmiss2 (GeV2) proton;Counts",nrun), 200, -.05,2.);
    HList.Add(hMmiss2_prot);
    TH1F *hMmiss2_pi= new TH1F("hMmiss2_pi",Form("Run %d ; Mmiss2 (GeV2) proton;Counts",nrun), 200, -.05,2.);
    HList.Add(hMmiss2_pi);
...
Long64_t nentries = tsimc->GetEntries();
	for (int i = 0; i < nentries; i++) {
		...
		hWcalc->Fill(W_calc);*/
		  ...
		  hEmiss->Fill(emiss);		  
		  hPmiss->Fill(pmiss);		  
		  if( aero > 2.) hMmiss2_pi->Fill(emiss*emiss-pmiss*pmiss);
		  if( aero <=2.) {
		    hMmiss2_prot->Fill(emiss*emiss-pmiss*pmiss);
		    hW_prot->Fill(W);
