...
#include<math.h>
using namespace std;
void comp_shms_ep( TString fn1 , TString fn2 ) {
 gROOT->Reset();
 gStyle->SetOptStat(0);
 gStyle->SetOptFit(11);
 ...
 gStyle->SetPadLeftMargin(0.14);
     TString outputpdf;
    outputpdf="plots/comp_shms_ep.pdf";
    //
const UInt_t nftot=2;
 Int_t colind[nftot]={1,2};
 TString lname[nftot]={"old fit","new fit"};
...
const UInt_t nplots=1;
 ...
 inputroot[1] = "hist/"+fn2+"_shms_ep_elastic_hist.root";
