...
void make_hist_deut_shms_ep_elastic(TString basename="",Int_t nrun=3288,Double_t pfac=0.981){
   if (basename=="") {
...
gStyle->SetPalette(1,0);
 ...
 gStyle->SetPadLeftMargin(0.12);
   TString inputroot;
   inputroot="ROOTfiles_cyero/"+basename+".root";
   TString outputhist;
   outputhist= "hist/"+basename+"_deut_shms_ep_elastic_hist.root";
 TObjArray HList(0);
 //
...
Double_t  e_mom;
 ...
 Double_t  ThScat;
   ...
   // Define histograms
    ...
    HList.Add(h_exfp);
    TH1F *pyfp = new TH1F("h_eyfp",Form("Run %d ; SHMS Y_fp;Counts",nrun), 100, -20.,20.);
    HList.Add(h_eyfp);
