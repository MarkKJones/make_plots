...
void comp_shms_dc() {
 ...
 gStyle->SetPadLeftMargin(0.14);
    TString basename = "shms_replay_dc_calib_1583_setting";
     TString outputpdf;
...
const UInt_t nplots=4;
 TString setname[nftot]={"15","17","16","18b","20"};
 Int_t colind[nftot]={1,2,3,4,6};
 TString lname[nftot]={"xt<100,yt<100,xpt<1. xpdiff<1000","xt<20,yt<5,xpt<.4 xpdiff<1000","xt<100,yt<100,xpt<1. xpdiff<.2","xt<20,yt<5,xpt<.4 xpdiff<0.2","smallAnlgeApprox"};
 //
